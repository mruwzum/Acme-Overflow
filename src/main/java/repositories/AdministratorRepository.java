...
public interface AdministratorRepository extends JpaRepository<Administrator, Integer> {
    ...
    Teacher teacherWithMoreWebinars();
    Teacher teacherWithLessWebinars();
    ...
    Webinar webinarWithMoreRegisteredUsers();
    Webinar webinarWithLessRegisteredUsers();
    ...
    User userwithMoreQuestionBanned();
    User userWithLessQuestionBanned();
    ...
    User userwithMoreAnswerBanned();
    User userWithLessAnswerBanned();
    Double averageNumberOfBannedAnswerPerUser();


    Double percetageOfBannedQuestions();
    Double percentageOfBannedAnswers();
    Double percentageOfBannedUser();
